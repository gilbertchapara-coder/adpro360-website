...
export function TestimonialCarousel() {
  ...
  return (
    <Section tone="ivory" paddingY="none" className="pb-section-y-alt-1 pt-0">
      <Reveal>
        <Container className="gap-testimonial-gap rounded-5xl grid grid-cols-[repeat(auto-fit,minmax(min(300px,100%),1fr))] items-center overflow-hidden bg-[linear-gradient(140deg,var(--color-navy)_0%,var(--color-link)_55%,var(--color-teal)_100%)] p-[var(--spacing-testimonial-band-y)] text-white">
          <div>
